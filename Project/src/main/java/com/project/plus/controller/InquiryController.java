...
public class InquiryController {
   ...
   public String editInquiryForm(InquiryVO vo, Model model) {
      ...
      return "mypage/inquiry/inquiryEditForm";
   }
   ...
   public String getInquiryList(Model model, HttpSession session, CriteriaMem cri) throws Exception {
      MemberVO user = (MemberVO) session.getAttribute("user");
      ...
      pgmm.setCriMem(cri);
      pgmm.setTotalCount(is.inquiryListCount(cri));
      model.addAttribute("pageMakerAdmin", pgmm);
