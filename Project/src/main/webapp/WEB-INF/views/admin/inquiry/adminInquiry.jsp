...
<body>
   <div class="Container">
      <div class="Content">
         <h4>1:1 문의 내역</h4>
         <!-- 정렬을 넣어볼까 했지만.. 일단 넣지않을게요 -->
<!-- <select name="searchCategory" id="searchCategory" style="margin-left:830px; margin-bottom:5px"onchange="cateOrder()">
               ...
               <div id="pageArea">
                  ...
                  <ul class="paging">
                     ...
                     <%-- <c:if test="${pageMakerAdmin.prev}"> --%>
                        <li><a class="span"
                           href="adminInquiry${pageMakerMem.makeQuery(pageMakerMem.startPage - 1)}">◀</a></li>
                     <%-- </c:if> --%>

                     <c:forEach begin="${pageMakerMem.startPage}"
                        end="${pageMakerMem.endPage}" var="idx">
                        <li><a href="adminInquiry${pageMakerMem.makeQuery(idx)}"><span
                              class="span">${idx}</span></a></li>
                     </c:forEach>

                     <%-- <c:if test="${pageMakerAdmin.next && pageMakerAdmin.endPage > 0}"> --%>
                        <li><a class="span"
                           href="adminInquiry${pageMakerMem.makeQuery(pageMakerMem.endPage + 1)}">▶</a></li>
                     <%-- </c:if> --%>
                  </ul>
