...
<body>
   <form action="answerInquiry" method="post"> 
      <div class="inquiry-wrap">
         ...
         <textarea name="inquiryAnswer" style="white-space:pre;" placeholder="[문의 내용]${answerInquiryForm.inquiryContent}"></textarea>      
         ...
         <!--  회원번호 진경 알림에게 넘겨주기  -->
         <button type="submit" class="btn btn-primary" id="answerBtn">답변 등록</button><br/>
